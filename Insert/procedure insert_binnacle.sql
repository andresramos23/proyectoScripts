create or replace procedure insert_binnacle(pUsername VARCHAR2, pProfilelink VARCHAR2)
is
val number;

BEGIN
    val :=s_binnacle.nextval();
    insert into binnacle(binnacle_id, user_name,profilelink)
    VALUES (val,pUsername, pProfilelink);
