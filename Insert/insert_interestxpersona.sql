create or replace procedure insert_interestXperson(pPersonid NUMBER, pInterestid NUMBER)
is

BEGIN
    insert into interestxperson(Person_Id,interest_Id)
        VALUES (pPersonid,pInterestid);
