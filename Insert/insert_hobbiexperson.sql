create or replace procedure insert_hobbieXperson(pPersonid NUMBER, pHobbieid NUMBER)
is

BEGIN
    insert into hobbiexperson(Person_Id,hobbie_Id)
        VALUES (pPersonid,pHobbieid);
