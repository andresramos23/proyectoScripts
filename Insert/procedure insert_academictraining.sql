create or replace procedure insert_academictraining(pAcademictraining VARCHAR2)
is
val number;

BEGIN
    val :=s_academictraining.nextval();
    insert into academic_training(academic_training_id, academic_level)
    VALUES (val,pAcademictraining);
