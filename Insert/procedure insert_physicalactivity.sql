create or replace procedure insert_physicalactivity(pFrequency NUMBER)
is
val number;

BEGIN
    val :=s_physicalactivity.nextval();
    insert into physical_activity(physical_activity_id,frequency)
        VALUES (val,pfrequency);
