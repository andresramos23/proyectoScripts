create or replace procedure insert_binnacleXperson(pPersonid NUMBER, pBinnacleid NUMBER)
is

BEGIN
    insert into Binnaclexperson(Person_Id,Binnacle_Id)
        VALUES (pPersonaid, pBinnacleid);
