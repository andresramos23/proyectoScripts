create or replace procedure insert_parameter(pName VARCHAR2, pDescription VARCHAR2, pValue VARCHAR2)
is
val number;

BEGIN
    val :=s_parameter.nextval();
    insert into parameter(parameter_id, parameter_name, parameter_description, parameter_value)
        VALUES (val, pName, pDescription, pValue);
